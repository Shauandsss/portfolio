...
export default (item) => {
  ...
  const handleLeftArrow = () => {
    let imageTagSize =
      document.getElementsByClassName("imgOnRoll")[0].clientWidth;
    if (scrollX - imageTagSize >= 0) setScrollX(scrollX - imageTagSize);
  };

  const handleRightArrow = () => {
    let imageTagSize =
      document.getElementsByClassName("imgOnRoll")[0].clientWidth;
    let containerTagSize =
      document.getElementsByClassName("container-pc")[0].clientWidth;
              ...
              {images && (
                <div
                  ...
                  style={{
                    ...
                    width:
                      images.length *
                      document.getElementsByClassName("container-pc")[0]
                        .clientWidth,
                  }}
                >
                  {images &&
